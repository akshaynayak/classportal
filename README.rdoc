...
Section Header	Admins should have higher authoritiy than ordinary members. Check the functionalities for admin below and see if they 
all work: 
...
checkbox	3) Can an admin view the details (course number, title, description, instructor, start date, end date, status) of a 
course?  Yes
...
checkbox	1) Can an admin add/remove students?  Yes by pressing on create a new admin/instructor and not leaving both is_instructor and is_student unchecked.
